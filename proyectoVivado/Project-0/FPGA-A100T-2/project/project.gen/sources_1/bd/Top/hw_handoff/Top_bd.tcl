...
proc create_root_design { parentCell } {
  ...
  # Create instance: ControlModule_0, and set properties
  set block_name ControlModule
  set block_cell_name ControlModule_0
  if { [catch {set ControlModule_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $ControlModule_0 eq "" } {
  ...
  set block_name matrixMult
  set block_cell_name matrixMult_0
  if { [catch {set matrixMult_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $matrixMult_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  # Create port connections
  connect_bd_net -net ACLK_1 [get_bd_pins ControlModule_0/clk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xdma_0/axi_aclk]
  connect_bd_net -net ControlModule_0_dataOut [get_bd_pins ControlModule_0/dataOut] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net ControlModule_0_enableDoOper [get_bd_pins ControlModule_0/enableDoOper] [get_bd_pins util_vector_logic_0/Op2]
  connect_bd_net -net ControlModule_0_led1 [get_bd_ports LED_A1] [get_bd_pins ControlModule_0/led1]
  connect_bd_net -net ControlModule_0_led2 [get_bd_ports LED_A2] [get_bd_pins ControlModule_0/led2]
  connect_bd_net -net ControlModule_0_led3 [get_bd_ports LED_A3] [get_bd_pins ControlModule_0/led3]
  connect_bd_net -net ControlModule_0_vector [get_bd_pins ControlModule_0/vectorOutToOper] [get_bd_pins matrixMult_0/vector]
  connect_bd_net -net LED_BLINKER_LED_ON_L [get_bd_ports LED_A4] [get_bd_pins LED_BLINKER/LED_ON_L]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins ControlModule_0/data] [get_bd_pins axi_gpio_0/gpio_io_o]
  connect_bd_net -net emc_clk_1 [get_bd_ports emc_clk] [get_bd_pins LED_BLINKER/CLK]
  connect_bd_net -net matrixMult_0_result [get_bd_pins ControlModule_0/vectorResult] [get_bd_pins matrixMult_0/result]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins matrixMult_0/clk] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_smc/aresetn] [get_bd_pins xdma_0/axi_aresetn]
  connect_bd_net -net xdma_0_user_lnk_up [get_bd_pins LED_BLINKER/OK] [get_bd_pins xdma_0/user_lnk_up]
